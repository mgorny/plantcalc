...
#ifndef PLANTCALC_EQUATIONS_MEDIUMSTATEEQUATION_HXX
#define PLANTCALC_EQUATIONS_MEDIUMSTATEEQUATION_HXX 1
...
public:
	 ...
	 * @param[in,out] p, T, h, s, x References to medium state variables.
	 */
